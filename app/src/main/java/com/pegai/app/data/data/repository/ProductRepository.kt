...
<<<<<<< HEAD:mobile/app/src/main/java/com/pegai/app/data/data/repository/ProductRepository.kt
...
object ProductRepository {
    ...
    fun salvarNoCache(produtos: List<Product>) {
        produtos.forEach { product ->
            cache[product.pid] = product
>>>>>>> develop_guilherme:app/src/main/java/com/pegai/app/data/data/repository/ProductRepository.kt
        }
    }
